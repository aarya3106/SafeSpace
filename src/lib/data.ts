...
export const relaxationSounds: RelaxationSound[] = [
    { id: 'white-noise', name: 'White Noise', description: 'Blocks out distractions', imageId: 'white-noise', audioUrl: 'https://cdn.freesound.org/previews/198/198841_285997-lq.mp3' },
    { id: 'pink-noise', name: 'Pink Noise', description: 'Deeper and more balanced', imageId: 'pink-noise', audioUrl: 'https://cdn.freesound.org/previews/513/513849_10215048-lq.mp3' },
    { id: 'brown-noise', name: 'Brown Noise', description: 'Lower, rumbling sound', imageId: 'brown-noise', audioUrl: 'https://cdn.freesound.org/previews/211/211684_285997-lq.mp3' },
    { id: 'ocean', name: 'Ocean Waves', description: 'Calming crash of waves', imageId: 'ocean', audioUrl: 'https://cdn.freesound.org/previews/173/173948_2394245-lq.mp3' },
    { id: 'rain', name: 'Gentle Rain', description: 'Soothing pitter-patter', imageId: 'rain', audioUrl: 'https://cdn.freesound.org/previews/341/341629_5121236-lq.mp3' },
